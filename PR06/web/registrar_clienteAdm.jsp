        ...
        <div id="cont">
            ...
            <section id="sec">
                <article id="art">
                	...
                	<form name="form" action="RegistrarClienteAdmController" method="post">
                            ...
                            <input type="submit" class="btn btn-default" name="entrar" value="Registrar" /> <a href="gestionar_clientes.jsp" class="btn btn-primary">Volver</a>
                	</form><br />
                </article>
            </section>
            <footer id="foot">
